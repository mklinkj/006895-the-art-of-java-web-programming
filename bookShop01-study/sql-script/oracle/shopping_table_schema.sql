...
-- REM 자체가  SQL Plus에서 주석으로 인식, 아무일도 하지 않음.
REM NSERTING into T_SHOPPING_GOODS


-- 그런데 DataGrip으로 스크립트 실행할 때는 ORA-00922: 누락된 또는 부적합한 옵션 오류가 난다.
...
-- sql plus에서 실행시에는 #문자를 이스케이프 처리해줘야할 수 있다.
