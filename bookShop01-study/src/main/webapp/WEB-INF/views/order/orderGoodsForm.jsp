...
<form name="form_order">
  ...
  <DIV class="detail_table">
    ...
    <table>
      ...
      <tr class="dot_line">
        ...
        <td><input id="receiver_name" name="receiver_name" type="text" size="40"
          ...
          <input type="hidden" id="h_orderer_name" name="h_orderer_name"
                 value="${orderer.member_name }"/>
          <input type="hidden" id="h_receiver_name" name="h_receiver_name"
                 value="${orderer.member_name }"/>
        </td>
      </tr>
      <tr class="dot_line">
      ...
      <tr class="dot_line">
        ...
        </select> - <input size="10px" type="text" id="tel2" name="tel2" value="${orderer.tel2 }"> -
      ...
      <tr class="dot_line">
        ...
        <td><input type="radio" id="gift_wrapping" name="gift_wrapping" value="yes">예
          &nbsp;&nbsp;&nbsp; <input type="radio" id="gift_wrapping" name="gift_wrapping" checked
                                    value="no">아니요
        </td>
        </td>
        </tboby>
  ...
  <table width=80% class="list_view" style="background: #ccffff">
    ...
    <tr cellpadding=40 align=center>
      ...
      <td><img width="25" alt="" src="${pageContext.request.contextPath}/resources/image/equal.jpg">
      </td>
      <td>
  ...
  <div class="detail_table">
    <table>
      ...
      <tr>
        <td>
          <input type="radio" id="pay_method" name="pay_method" value="신용카드" onClick="fn_pay_card()"
                 checked>신용카드 &nbsp;&nbsp;&nbsp;
      ...
      <tr>
        <td>
          <input type="radio" id="pay_method" name="pay_method" value="휴대폰결제"
                 onClick="fn_pay_phone()">휴대폰 결제 &nbsp;&nbsp;&nbsp;
