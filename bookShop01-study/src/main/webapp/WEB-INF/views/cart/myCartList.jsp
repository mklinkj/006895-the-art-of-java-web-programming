...
<table class="list_view">
  ...
  <tr>
    <form name="frm_order_all_cart">
      ...
      <td><input type="checkbox" name="checked_goods" checked value="${item.goods_id }"
      ...
      <td>
        <strong>
          <fmt:formatNumber value="${item.goods_sales_price*0.9}" type="number"
                            var="discounted_price"/>
            ${discounted_price}원(10%할인)
        </strong>
      </td>
      <td>
        <input type="text" id="cart_goods_qty" name="cart_goods_qty" size=3
      ...
      <td>
        <strong>
          <fmt:formatNumber value="${item.goods_sales_price*0.9*cart_goods_qty}" type="number"
  ...
  <tr cellpadding=40 align=center>
    ...
    <td>
      <p id="p_final_totalPrice">
        <fmt:formatNumber value="${totalGoodsPrice+totalDeliveryPrice-totalDiscountedPrice}"
