  ...
  <div id="detail_table">
    <table>
      ...
      <tr class="dot_line">
        ...
        </select> - <input size="10px" type="text" name="tel2"> - <input size="10px" type="text"
                                                                         name="tel3">
        </td>
      </tr>
      <tr class="dot_line">
        ...
        </select> - <input size="10px" type="text" name="hp2"> - <input size="10px" type="text"
                                                                        name="hp3"><br> <br>
      ...
      <tr class="dot_line">
        ...
        <td><input size="10px" type="text" name="email1"/> @ <input size="10px" type="text"
          ...
          </select><br> <br> <input type="checkbox" name="emailsts_yn" value="Y" checked/> 쇼핑몰에서
          발송하는 e-mail을 수신합니다.
        </td>
      </tr>
      <tr class="dot_line">
